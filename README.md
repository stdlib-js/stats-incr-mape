...
```javascript
incrmape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mape@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-incr-mape/tags). For example,

```javascript
incrmape = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mape@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var incrmape = require( 'path/to/vendor/umd/stats-incr-mape/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-incr-mape@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-incr-mape/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-incr-mape/actions/workflows/test.yml?query=branch:v0.2.2
...
[deno-readme]: https://github.com/stdlib-js/stats-incr-mape/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-incr-mape/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-incr-mape/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-incr-mape/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-incr-mape/blob/esm/README.md
